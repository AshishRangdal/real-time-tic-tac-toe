                    ...
                    {playersCount < 2 ? (
                        ...
                        <>
                            ...
                            {isGameStarted && isGameOver && (
                                <button
                                    onClick={onResetGame}
                                    className="group flex items-center gap-2 rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 px-5 py-2 text-sm font-bold text-white shadow transition-transform hover:scale-105 hover:from-blue-600 hover:to-purple-600 hover:shadow-xl md:text-base"
                                >
